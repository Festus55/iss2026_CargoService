---
title: cargo service ingegneria dei sistemi software 2026
author: Leonardo Barone, Leonardo Ciacco
...
- In caso contrario, considera il sistema come **attivo**, individua uno slot libero e restituisce come risposta il nome di tale slot riservato.  
    Mentre è attivo, il sistema deve far lampeggiare un LED.

Quando la _richiesta di carico_ viene accettata, il cliente deve spostare il contenitore nell’area del _sensore sonar_ entro un tempo prestabilito (e.g. 30 secondi), altrimenti il sistema si **disattiva**.  
